...
enum KeyboardLayout
{
    ...
    SCIM_KEYBOARD_Colemak                       = 3,
    SCIM_KEYBOARD_Croatian                      = 4,
    SCIM_KEYBOARD_Czech                         = 5,
    SCIM_KEYBOARD_Czech_Qwerty                  = 6,
    SCIM_KEYBOARD_Danish                        = 7,
    SCIM_KEYBOARD_Dutch                         = 8,
    SCIM_KEYBOARD_Dvorak                        = 9,
    SCIM_KEYBOARD_Dvoraki                       = 10,
    SCIM_KEYBOARD_Estonian                      = 11,
    SCIM_KEYBOARD_Finnish                       = 12,
    SCIM_KEYBOARD_French                        = 13,
    SCIM_KEYBOARD_French_Canadian               = 14,
    SCIM_KEYBOARD_French_Switzerland            = 15,
    SCIM_KEYBOARD_German                        = 16,
    SCIM_KEYBOARD_German_Deadkeys               = 17,
    SCIM_KEYBOARD_German_Swiss                  = 18,
    SCIM_KEYBOARD_Greek                         = 19,
    SCIM_KEYBOARD_Hungarian                     = 20,
    SCIM_KEYBOARD_Italian                       = 21,
    SCIM_KEYBOARD_Japanese                      = 22,
    SCIM_KEYBOARD_Norwegian                     = 23,
    SCIM_KEYBOARD_Polish                        = 24,
    SCIM_KEYBOARD_Portuguese                    = 25,
    SCIM_KEYBOARD_Portuguese_Brazil             = 26,
    SCIM_KEYBOARD_Portuguese_Brazil_US_Accents  = 27,
    SCIM_KEYBOARD_Russian                       = 28,
    SCIM_KEYBOARD_Slovak                        = 29,
    SCIM_KEYBOARD_Slovak_Qwerty                 = 30,
    SCIM_KEYBOARD_Slovene                       = 31,
    SCIM_KEYBOARD_Spanish                       = 32,
    SCIM_KEYBOARD_Spanish_CP850                 = 33,
    SCIM_KEYBOARD_Spanish_Latin_America         = 34,
    SCIM_KEYBOARD_Swedish                       = 35,
    SCIM_KEYBOARD_Turkish                       = 36,
    SCIM_KEYBOARD_UK                            = 37,
    SCIM_KEYBOARD_Icelandic                     = 38,
    SCIM_KEYBOARD_Lithuanian                    = 39,
    SCIM_KEYBOARD_Ukrainian                     = 40,
    SCIM_KEYBOARD_NUM_LAYOUTS                   = 41
};
